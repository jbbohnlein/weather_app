...
const Forecast = ({ data }: Props): JSX.Element => {
    ...
    return (
        // Set the layout of the glass background
        ...
        {/* Top section with city, temp, general forecast, temps */}
        ...
        {/* Scrollable, horizontal display of temperatures with weather icons */}
        ...
        {/* Sunrise and Sunset Section */}
            ...
            <section 
                className="flex flex-wrap justify-between text-zinc-700">
                <div className="w-[140px] text-xs font-bold flex flex-col items-center bg-white/20 backdrop-blur-lg 
            ...
            {/* Section for Wind, Feels Like, Precip, Humidity, Pressure, and Visibility using Tile Component */}
            <Tile
            icon="wind"
            title="Wind"
